...
class Admin extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $sql = "SELECT tasks.*, priorities.priority_name
        FROM tasks 
        ...
        $data['rows'] = $task->query($sql, ['assigned_to'=>$id]); //$task->where(['assigned_to'=>$id]);
...
//PROFILE METHHODS
  ...
  public function ajaxData($action =null, $id = null)
  {
    ...
    $task = new Task();
      ...
      if($action == "view")
      {
        ...
        // $sql = "SELECT tasks.*, users.username, priorities.priority_name
        // FROM tasks 
  ...
  public function assignedtasks($action=null, $id=null)
  {
   ...
   if(Auth::getRole_name() == 'admin')
    ...
    $data['priorities']= $priority->findAll();

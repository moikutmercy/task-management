          ...
          <table class="table  table-striped">
            ...
            <tbody>
              <?php foreach($rows as $row):?>
                ...
                <?php     
                    ...
                    $actions_remaining = 1;
                    $interval = $duration / $actions_remaining;
                    $last_action_time = $end_time - $interval;
                    ?>
                <?php if (time() >= $last_action_time):?>
                  <?php
                      $current_date = date('Y-m-d', time());
                      $tomorrow_date = date('Y-m-d', strtotime('+1 day'));
                  
                    ?>
                    <?php if ($current_date > date('Y-m-d', $end_time)):?>
                    <tr>

                      <td class="text-danger" colspan=4>The task is overdue. You need to complete it...</td>
                    </tr>
                    <?php else:?>
                      <tr>

                        <td class="text-primary" colspan=3>You have time to complete the task.</td>
                        </tr>
                    <?php endif?>
                <?php endif;?>
                <tr>
            ...
            <?php elseif($status == "In progress"):?>
              ...
              <?php else:?>
                ...
                <?php endif?>
                <td class="text-danger"><?php echo esc($row->priority_name)?></td>
              <td>

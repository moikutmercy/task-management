...
<!--MODAL-->
      ...
      <div class="modal-dialog  modal-lg">
        <div class="modal-content">
          ...
          <form method="POST">
                      ...
                      <!-- <div class="row mb-3">
                        <label for="inputEmail" class="col-sm-2 col-form-label">Task Priority</label>
                        <div class="col-sm-10">
                          <input placeholder="Task Priority" name="task_priority" value= "<?php echo set_value('task_priority')?>" type="text" class="form-control" required>
                        </div>
                      </div> -->
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          ...
                          <select placeholder="Task Priority" name="priority_id" class="form-select" aria-label="Default select example" required>
                            
                          <?php foreach($priorities as $row):?>
                        
                            <option value="<?php echo esc($row->id)?>"><?php echo esc($row->priority_name)?></option>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <?php elseif($status == "Incomplete"):?>
              ...
              <td style="font-size:13px;" class="d-flex">
          ...
          <form method="POST">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          ...
                          <?php if(!empty($priorities)):?>
                          <select placeholder="Task Priority" name="task_priority" class="form-select id_p" aria-label="Default select example" required>
                            
                          <?php foreach($priorities as $row1):?>
                        
                            <option class="task_priority" value="<?php echo esc($row1->id)?>"><?php echo esc($row1->priority_name)?></option>
            ...
            <?php else:?>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  ...
                  <input placeholder="Task Priority"  disabled class="form-control id_p " disabled name="priority_" value= "Open dashboard to view Priority" type="text"  required>
                </div>
              </div>
  ...
  <script>
      ...
      //console.log(response);
              response.forEach(task => {
               ...
               // 
                ...
                document.querySelector(".task_priority").innerHTML = task.priority_name;
               // document.querySelector(".task_priority").value = task.priority_id;
    ...
    function sendData()
    {
      ...
      var selectedPrio =document.querySelector(".id_p").value;
